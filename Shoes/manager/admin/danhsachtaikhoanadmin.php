...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
	<script>
		...
		function adduser(){
			$("#themtaikhoan").load("themtaikhoanadmin.php");
	...
	<div class="modal " id="myModalsua" role="dialog" >
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Admin Account Table</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Admin Account Table</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Admin Account Table</div>
						...
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<?php
									include('../connect.php');
			  						$class1=new Database();
									$sqluser="select * from admin_account";
									...
									foreach($dataluser as $key=>$value){
										print_r('<tr>
											...
											<button class="btn btn-info btn-sm" name="edit" title="Edit admin information" id="'.$value['username'].'" onClick="edituser(this)"><i class="fa fa-edit"></i></button>
											<button class="btn btn-danger btn-sm" name="delete" title="Delete admin" onClick="deleteuser(\''.$value['username'].'\')"><i class="fa fa-trash-o"></i></button>
											</td>
										</tr>');
									}
